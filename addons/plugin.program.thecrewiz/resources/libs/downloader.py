...
def _pbhook(numblocks, blocksize, filesize, dp, start_time, bn):
    try: 
        ...
        mbs = '[COLOR %s][B]Size:[/B] [COLOR %s]%.02f[/COLOR] MB από [COLOR %s]%.02f[/COLOR] MB[/COLOR]%s' % (COLOR2, COLOR1, currently_downloaded, COLOR1, total, msg) 
        ...
        dp.update(int(percent), 'Downloading %s[CR]%s[CR]%s'% (bn, mbs, e))
