...
def buildCount(ver=None, url=None):
    ...
    total = 0; count15 = 0; count16 = 0; count17 = 0; count18 = 0; count19 = 0; count20 = 0; count21 = 0; hidden = 0; adultcount = 0
    if len(match) > 0:
        for name, kodi, adult in match:
            ...
            kodi = int(float(kodi))
            total += 1
            if kodi == 21: count21 += 1
            elif kodi == 20: count20 += 1
            elif kodi == 19: count19 += 1
            elif kodi == 18: count18 += 1
            elif kodi == 17: count17 += 1
            elif kodi == 16: count16 += 1
            elif kodi <= 15: count15 += 1
    return total, count15, count16, count17, count18, count19, count20, count21, adultcount, hidden
    ...
    if workingURL(WIZARDFILE):
        ...
        if ver > VERSION:
            ...
            if yes:
                ...
                downloader.download(zip, lib, DP,'Update')
                xbmc.sleep(2000)
